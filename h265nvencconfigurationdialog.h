#ifndef H265NVENCCONFIGURATIONDIALOG_H
#define H265NVENCCONFIGURATIONDIALOG_H
...
namespace Ui {
class h265NVENCConfigurationDialog;
}

class h265NVENCConfigurationDialog : public QDialog
{
    Q_OBJECT

public:
    explicit h265NVENCConfigurationDialog(QWidget *parent = nullptr);
    ~h265NVENCConfigurationDialog();

signals:
    void configuration_changed();

private slots:
    void on_h265_nvenc_ok_button_clicked();

private slots:
    void on_h265_nvenc_cancel_button_clicked();

private slots:
    void on_h265_nvenc_restore_button_clicked();

private:
    Ui::h265NVENCConfigurationDialog *ui;
...
#endif // H265NVENCCONFIGURATIONDIALOG_H
